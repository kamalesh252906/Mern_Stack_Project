...
import { Plus, Search, Filter, Eye, CheckCircle2, Inbox, AlertCircle } from 'lucide-react';
              ...
              {filteredTickets.length > 0 ? (
                filteredTickets.map((ticket) => (
                  <tr key={ticket.id}>
                    ...
                    <td>
                      <Link to="#" className="table-subject-link">
                        {ticket.subject}
                      </Link>
                    </td>
                    <td>
                    ...
                    <td className="table-actions-right">
                      <Link to="#" className="btn btn-secondary btn-xsmall">
                        <Eye size={14} />
                        <span>View</span>
                      </Link>
                    </td>
